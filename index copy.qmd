...
::: r-fit-text
For now, our territory is data

so our story lives in the viz
:::
...
Rhea and I turned our daily Wordle fights into an data project that's been running 2 years.

Not world-changing for sure.

:::

::: {.column width="60%"}

![]( attachments/2026-02-25-01-08-22.png){width="90%"}
...
scoobydoo %>%
  ...
  summarize(
    "caught_by_daphne" = n(),
    "total_episodes" = first(total_episodes) # This pulls just one "603"
  ) %>%
  kable()
...
::: r-fit-text
// Show David Robinson screencasts
:::
...
::: {.incremental}
- **Read:** The Pudding, Flowing Data, Nightingale (the DVS journal), Reuters Graphics
- **Practice:** Tidy Tuesday — a weekly shared dataset, usable in any tool
- **Make:** Pick one personal project. Challenge one specific thing — a new analysis method, a new visual form, a tool you've never tried
:::
